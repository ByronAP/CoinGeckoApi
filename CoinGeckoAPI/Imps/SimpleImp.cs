...
namespace CoinGeckoAPI.Imps
{
    ...
    public class SimpleImp
    {
        ...
        /// <param name="vs_currencies">The target currency of market data (usd, eur, jpy, etc.). See <see cref="GetSupportedVSCurrenciesAsync"/>.</param>
        ...
        /// <param name="precision">Any value 0 through 18 to specify decimal place for currency price value. Default: 2.</param>
        /// <returns>A Task&lt;Dictionary&lt;string, Dictionary&lt;string, decimal&gt;&gt;&gt; representing the asynchronous operation.</returns>
        /// <exception cref="ArgumentNullException">id - Invalid value. Value must be a valid id of the platform issuing tokens (See asset_platforms endpoint for list of options)</exception>
        /// <exception cref="ArgumentOutOfRangeException">precision - Value must be 0 through 18</exception>
